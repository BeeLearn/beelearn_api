    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('type', models.TextField(choices=[('TEXT', 'TEXT'), ('DRAG_DROP', 'Drag Drop'), ('TEXT_OPTION', 'TEXT_OPTION'), ('SINGLE_CHOICE', 'Multiple Choice'), ('MULTIPLE_CHOICE', 'Multiple Choice')], max_length=128)),
            ],
        ),
        migrations.CreateModel(
            name='Topic',
