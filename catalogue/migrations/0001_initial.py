    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('likes', models.ManyToManyField(blank=True, related_name='topic_comment_likes', to=settings.AUTH_USER_MODEL)),
                ('sub_topic_comments', models.ManyToManyField(blank=True, to='catalogue.topiccomment')),
                ('topic', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='catalogue.topic')),
                ('user', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='topic_comment_users', to=settings.AUTH_USER_MODEL)),
            ],
            options={
                'ordering': ('-updated_at', 'created_at'),
            },
