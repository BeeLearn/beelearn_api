    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('type', models.TextField(choices=[('REWARD_ACHIEVE', 'Reward achieved'), ('LESSON_COMPLETE', 'Lesson completed'), ('STREAK_COMPLETE', 'Streak completed'), ('LEAGUE_COMPLETE', 'League Completed')], max_length=128)),
